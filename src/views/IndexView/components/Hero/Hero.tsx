...
// const markerShadow = require('assets/images/woman.jpg');
// import markerShadow from '../../../../assets/images/woman.jpg';
...
const useStyles = makeStyles(theme => ({
  root: {
    ...
    // background: './assets/images/woman.jpg',
  ...
  return (
    <div className={clsx(classes.root, className)} {...rest}>
      <Section className={classes.section}>
        ...
        <SectionHeader
          title={
            <span className={classes.textWhite}>Your house impression stops at the verge</span>
          }
          subtitle={
            <span className={classes.textWhite}>
              We help you keep it perfect...
            </span>
          }
          align="left"
          titleVariant="h3"
